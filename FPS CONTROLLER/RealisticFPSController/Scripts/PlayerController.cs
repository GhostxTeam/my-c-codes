...
namespace EvolveGames
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        AudioSource Source;
        bool İsMoving;
        public AudioClip[] UntaggedSounds;
        public AudioClip[] GrassSounds;
        public AudioClip[] AsphaltSounds;
        int soundControl;
        void Start()
        {
        ...
        void Update()
        {
            ...
            if (İsMoving && characterController.isGrounded)
            {
                ...
                if (timer <= 0)
                {
                    switch (soundControl)
                    {
                        case 0: Source.clip = UntaggedSounds[Random.Range(0, UntaggedSounds.Length)]; break;
                        case 1: Source.clip = GrassSounds[Random.Range(0, GrassSounds.Length)]; break;
                        case 2: Source.clip = AsphaltSounds[Random.Range(0, AsphaltSounds.Length)]; break;
